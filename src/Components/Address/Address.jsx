  ...
  return (
    ...
    <div className='w-75 m-auto my-5'>
      ...
      <form onSubmit={handleSubmit} >
            ...
            <input onBlur={handleBlur} onChange={handleChange} value={values.details} type="text" className='form-control mb-3' id='details' name='details' />
            ...
            <input onBlur={handleBlur} onChange={handleChange} value={values.city} type="text" className='form-control mb-3' id='city' name='city' />
            ...
            {
              isLoading ? <button  type='button' className='btn bg-main px-3 text-white ms-auto d-block px-4'><i className='fas fa-spin fa-spinner'></i></button> :
                          <button disabled={isLoading || !isValid} type='submit' className='btn bg-main px-3 text-white ms-auto d-block'>Checkout</button>
            }
        </form>
    </div>
    </>
