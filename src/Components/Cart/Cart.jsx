...
return (
    ...
    {cart.data?.products.map((cartProduct)=>{
      return <CartProduct updateCartProductCount={updateCartProductCount} removeProductFromCart={removeProductFromCart} key={cartProduct._id}  cartProduct={cartProduct}/>
    })}
    ...
    :
    <h2 className='alert alert-warning text-center py-4 my-4'>No Products In Your cart</h2>
    }
    </>
    }
